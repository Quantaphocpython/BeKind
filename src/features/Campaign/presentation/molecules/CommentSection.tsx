...
import { getShortAddress } from '@/features/User/data/utils'
                  ...
                  <div key={comment.id} className="space-y-3">
                    ...
                    <div className="group relative">
                          ...
                          <div className="mt-2 p-2 rounded-lg border bg-muted/30">
                            ...
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="text-xs text-muted-foreground">
                                {t('Replying to')} {comment.user?.name || getShortAddress(comment.user?.address || '')}
                              </span>
                            </div>
                      ...
                      {hasReplies && isExpanded && (
                        <div className="ml-6 mt-2 space-y-2 border-l-2 border-muted/50 pl-3">
                          {comment.replies.map((reply) => (
                            <div
                              key={reply.id}
                              className="flex gap-2 p-3 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors"
                            >
                              <UserDisplay
