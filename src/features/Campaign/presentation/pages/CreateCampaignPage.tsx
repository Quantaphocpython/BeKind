        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Transparent Funding</h3>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Built on blockchain technology ensuring security and immutability.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Connect with donors from around the world to maximize your impact.
              </p>
            </div>
          </div>
        </div>
