export interface IHttpClient {
   ...
   */
  setRequestInterceptor: (interceptor: (config: RequestInit) => RequestInit | Promise<RequestInit>) => void
...
class HttpClient implements IHttpClient {
  ...
  public setRequestInterceptor(interceptor: (config: RequestInit) => RequestInit | Promise<RequestInit>) {
